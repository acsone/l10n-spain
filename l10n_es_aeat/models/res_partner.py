...
class ResPartner(models.Model):
    ...
    is_aeat_anonymous_cash_customer_visible = fields.Boolean(
        compute="_compute_is_aeat_anonymous_cash_customer_visible"
    )

    @api.depends('company_id')
    def _compute_is_aeat_anonymous_cash_customer_visible(self):
        for rec in self:
            rec.is_aeat_anonymous_cash_customer_visible = (
